-- Script khởi tạo database theo schema thực tế
USE master;
GO
...
IF NOT EXISTS (SELECT * FROM tasks WHERE title = N'Tạo giao diện đăng nhập')
BEGIN
...
PRINT 'Database task_manager2 initialized successfully with sample data!';
PRINT 'Users created: admin, john_doe, jane_smith, hungtran, linhvu';
PRINT 'Tasks created: 5 sample tasks assigned to users';
GO